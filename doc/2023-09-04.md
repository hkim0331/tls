...
cond は conditional の略だろうな。lambda の歴史は古く、
コンピュータが登場する以前に
「計算って一体なんだろう？」なんてことを考えた数学者たちが論文で使ってた記号に基づいている。ラムダを知らずにプログラミングを教える人はモグリと思ってよし。やる気のない連中と重なる。
